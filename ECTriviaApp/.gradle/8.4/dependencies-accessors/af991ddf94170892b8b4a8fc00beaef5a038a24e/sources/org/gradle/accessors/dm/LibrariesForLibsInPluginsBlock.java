...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KrossbowLibraryAccessors laccForKrossbowLibraryAccessors = new KrossbowLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at krossbow
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KrossbowLibraryAccessors getKrossbow() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKrossbowLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class KrossbowLibraryAccessors extends SubDependencyFactory {
        private final KrossbowWebsocketLibraryAccessors laccForKrossbowWebsocketLibraryAccessors = new KrossbowWebsocketLibraryAccessors(owner);

        public KrossbowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for stomp (org.hildan.krossbow:krossbow-stomp-core)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getStomp() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("krossbow.stomp");
        }

        /**
         * Returns the group of libraries at krossbow.websocket
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KrossbowWebsocketLibraryAccessors getWebsocket() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKrossbowWebsocketLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KrossbowWebsocketLibraryAccessors extends SubDependencyFactory {

        public KrossbowWebsocketLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for okhttp (org.hildan.krossbow:krossbow-websocket-okhttp)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("krossbow.websocket.okhttp");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: krossbow (5.8.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKrossbow() { return getVersion("krossbow"); }
